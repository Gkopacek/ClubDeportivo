...
namespace MenuPrincipalClub.Forms
{
    public partial class frmRegistrarSocio : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var servicioSocio = new MenuPrincipalClub.Servicios.ServicioSocio();
            var documento = textBox1.Text.Trim();
            var usuario = servicioSocio.ObtenerUsuarioPorDocumento(documento);
            if (usuario != null)
            {
            ...
            else
            {
                ...
                servicioSocio.InsertarUsuario(nuevoUsuario); // Asegúrate de que este método exista en ServicioCliente
