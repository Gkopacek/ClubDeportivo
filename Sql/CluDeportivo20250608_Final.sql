...
INSERT INTO `clientes` VALUES (1,'Juani','Pérez','1234567890','juan.perez@example.com','555-1234','2025-06-01 23:03:20'),(3,'pepito','elPistolero','987654321','elpepito@gmial.com','1523456789','2025-06-01 23:22:09'),(4,'GUisgho','komposta','1324323453456','kopac@gmai.nc','12340987','2025-06-08 21:04:23'),(5,'Nahuel','Bombita','1234567','Laboba@mailincendiario.com','12432565','2025-06-08 22:48:34');
...
CREATE TABLE `configuracion` (
  `Valor_Cuota` decimal(10,0) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `configuracion` VALUES (25000);
...
DROP TABLE IF EXISTS `pagos_actividades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pagos_actividades` (
  ...
  PRIMARY KEY (`idpago_actividad`),
  KEY `idActividad_idx` (`idActividad`),
  KEY `NCliente_idx` (`NCliente`),
  CONSTRAINT `idActividad` FOREIGN KEY (`idActividad`) REFERENCES `actividades` (`idActividad`),
  CONSTRAINT `NCliente` FOREIGN KEY (`NCliente`) REFERENCES `clientes` (`NCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `pagos_actividades` WRITE;
/*!40000 ALTER TABLE `pagos_actividades` DISABLE KEYS */;
/*!40000 ALTER TABLE `pagos_actividades` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pagos_cuotas` (
  ...
  CONSTRAINT `pagos_cuotas_ibfk_1` FOREIGN KEY (`Nsocio`) REFERENCES `socios` (`Nsocio`)
...
INSERT INTO `roles` VALUES (120,'Administrador');
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ActualizarSocio`(IN `socio_id` INT, IN `nuevo_nombre` VARCHAR(100), IN `nuevo_documento` VARCHAR(20), IN `nuevo_estado` ENUM('activo','inactivo'))
BEGIN
    UPDATE socios 
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `BuscarSocioPorDocumento`(IN `p_documento` VARCHAR(20))
BEGIN
    SELECT *
    FROM socios
    WHERE documento = p_documento;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EliminarSocio`(IN `socio_id` INT)
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertarSocio`(IN `nombre` VARCHAR(100), IN `documento` VARCHAR(20), IN `fecha` DATE, IN `estado` ENUM('activo','inactivo'))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ObtenerValorCuota` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ObtenerValorCuota`()
BEGIN
    -- Selecciona el valor de la columna Valor_Cuota en una variable OUT para devolverlo al C#
    SELECT Valor_Cuota FROM configuracion;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-06-08 20:47:45
